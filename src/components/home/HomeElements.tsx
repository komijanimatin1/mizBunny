...
const HomeElements = () => {
    return (
        <div className="overflow-auto scrollbar-hide scroll-smooth bg-white w-full h-[calc(100%-theme(spacing.14))] rounded-2xl [&::-webkit-scrollbar]:hidden flex flex-col mt-safe-8">
            <Banner/>
